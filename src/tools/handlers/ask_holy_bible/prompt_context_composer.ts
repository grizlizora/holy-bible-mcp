...
import { RetrievedVerse } from "./verse_context_retriever.js";

export interface GroundingComposerOptions {
  question: string;
  detectedLang: string;
  paramSizeB: number;
  tier: any;
...
export class PromptContextComposer {
  public static compose(options: GroundingComposerOptions): string {
    const {
      question,
      detectedLang,
      paramSizeB,
