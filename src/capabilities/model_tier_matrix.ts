...
export function resolveModelTier(parameterSizeB: number): ModelTier {
  if (parameterSizeB <= 8.5) return 'tier1';
  if (parameterSizeB <= 10.5) return 'tier1_5';
  if (parameterSizeB <= 24.9) return 'tier2';
  return 'tier3';
}
