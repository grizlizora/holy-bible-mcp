...
export class CrossPlatformPath {
  private static APP_DIR_NAME = 'holy-bible-mcp';
   ...
   */
  public static getDirectivesDbPath(): string {
   ...
   */
  public static getOsisDictionaryPath(): string {
    const candidatePaths = [
   ...
   */
  public static toPosixPath(filePath: string): string {
   ...
   */
  public static normalizeWindowsUnc(filePath: string): string {
