...
export interface ArchetypeItem {
  keywords: string[];
  dimension: string;
  scripture_archetype: string;
}

export const UNIVERSAL_ARCHETYPES: ArchetypeItem[] = [
  {
...
export function getSensitivityDirective(score: number = 80): { score: number; label: string; directive: string } {
