...
export async function loadDirectivesFromDb(db) {
    ...
    const [tierRes, modeRes, warmthRes, metricsRes, moduleRes, transRes, synRes, propRes, chainRes, metaRes, osisRes, aliasRes] = await Promise.allSettled([
