...
export async function handleGetVerse(args) {
...
export async function handleGetChapterContext(args) {
...
export async function handleGetParallelVerses(args) {
...
export async function handleCompareTranslationsDiff(args) {
    const book = String(args?.book || "JHN");
...
export async function handleGetTranslationMetadata(args) {
