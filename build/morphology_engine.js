...
export class MorphologyEngine {
    ...
    static async getInterlinearVerse(book, chapter, verse, lang = 'auto', parallelTranslation = 'UBIO') {
       ...
       WHERE LOWER(translation) = LOWER(?) AND UPPER(book) = ? AND chapter = ? AND verse = ? LIMIT 1`, [transCode, osisBook, chapter, verse]);
     ...
     */
    static async getStrongsEtymology(strongsInput) {
