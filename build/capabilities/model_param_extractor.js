...
export function extractModelParamSizeB(modelName, details) {
    ...
    if (name.includes('deepseek-r1') ||
        ...
        if (name.includes('70b'))
            return 70.0;
        if (name.includes('32b'))
            return 32.0;
        if (name.includes('14b'))
            return 14.0;
        if (name.includes('8b'))
            return 8.0;
        if (name.includes('7b'))
    ...
    if (name.includes('mistral-large'))
        return 123.0;
    if (name.includes('mistral-small') || name.includes('mistral-nemo'))
        return 12.0;
    if (name.includes('mistral') || name.includes('mixtral'))
        return 7.0;
    if (name.includes('phi-4') || name.includes('phi4'))
        return 14.0;
    if (name.includes('phi-3.5') || name.includes('phi3.5') || name.includes('phi-3') || name.includes('phi3'))
        return 3.8;
    if (name.includes('gemma-2') || name.includes('gemma2')) {
        if (name.includes('27b'))
            return 27.0;
        if (name.includes('9b'))
            return 9.0;
        if (name.includes('2b'))
    ...
    if (name.includes('smollm2') || name.includes('smollm')) {
        if (name.includes('1.7b'))
            return 1.7;
        if (name.includes('360m'))
            return 0.36;
        if (name.includes('135m'))
            return 0.135;
        return 1.7;
    }
